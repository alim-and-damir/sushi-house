  ...
  return (
    <>
      <div
        ...
        className="w-full bg-[#2F4A5A] text-white rounded-[3.5rem] p-2 shadow-xl relative overflow-hidden mb-6 transition-transform transform active:scale-[0.98] duration-200 cursor-pointer group"
      >
