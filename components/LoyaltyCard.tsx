  ...
  return (
    <>
      <div
        ...
        className="w-full bg-[#2F4A5A] text-white rounded-[3.5rem] p-2.5 shadow-xl relative overflow-hidden mb-6 transition-transform transform active:scale-[0.98] duration-200 cursor-pointer group"
      >
        ...
        <div className="flex items-center justify-between relative z-10">
          ...
          <div className="flex-1 flex justify-center px-4">
            <img
              src="https://i.postimg.cc/d33Jrn9k/f85bdc0e-f9dd-4f52-8748-d0e15d6d3da7.png"
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-[2rem] p-6 w-full max-w-[320px] relative z-[101] shadow-2xl flex flex-col items-center animate-pop-in">
            ...
            <div className="flex flex-col items-center mb-4 w-full">
              ...
              <div className="text-[9px] font-black text-[#2F4A5A] bg-[#F6F4F3] px-2 py-0.5 rounded-full mt-1 border border-[#EBE7E4] tracking-wider">
                ID: {user.id}
              </div>
            </div>
            ...
            <div className="w-full space-y-3">
              <div className="w-full bg-[#F6F4F3] rounded-2xl p-4 text-center border border-[#EBE7E4]">
                 <p className="text-[9px] text-[#2F4A5A] uppercase tracking-[0.2em] font-black mb-1">Ваш баланс</p>
            ...
            <p className="mt-4 text-[8px] text-slate-600 font-black tracking-[0.1em] text-center uppercase leading-tight px-2">
              Для получения баллов покажите код<br/>официанту при оплате заказа
            </p>
          </div>
        </div>,
        document.body
