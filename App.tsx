...
const AppContent: React.FC = () => {
        ...
        import('./services/api').then(({ api }) => {
          api.syncUser(tgUser)
            ...
            .catch(err => {
              ...
              // level and nextLevelPoints will be calculated by setAuth
              setAuth({
                id: tgUser.id,
                name: `${tgUser.first_name} ${tgUser.last_name || ''}`.trim(),
                avatarUrl: tgUser.photo_url || `https://ui-avatars.com/api/?name=${tgUser.first_name}&background=22305d&color=fff`,
                points: 340,
                lifetimePoints: 420,
  ...
  if (!isAuth) {
    return (
      <div className="h-screen w-full flex items-center justify-center bg-[#F4F2ED]">
  ...
  return (
    <div className="min-h-screen font-sans text-gray-900 bg-[#F4F2ED]">
      <Routes>
