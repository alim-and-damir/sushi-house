  ...
  return (
    <div className="min-h-screen bg-[#F4F2ED] pb-24 font-sans">
      <div className="bg-white p-4 border-b border-gray-100 sticky top-0 z-50 flex items-center gap-4">
        ...
        <h1 className="font-bold text-lg">Адрес</h1>
      </div>
            ...
            >
              <div className="flex items-start gap-4">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 transition-colors ${
                  isSelected ? 'bg-[#2F4A5A] text-white' : 'bg-[#2F4A5A]/10 text-[#2F4A5A]'
                }`}>
                  <MapPin size={24} />
                </div>
                ...
                {isSelected && (
                  <div className="bg-[#2F4A5A] text-white p-1 rounded-full animate-pop-in">
