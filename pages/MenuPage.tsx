      ...
      <div className="px-4 space-y-8 mt-6">
        ...
        <div className="pt-4 pb-6 text-center animate-fade-in stagger-6 opacity-0 fill-mode-forwards">
          ...
          <div className="flex justify-center gap-4">
            <a href="https://www.instagram.com/sushihouse.nalchik/" target="_blank" rel="noreferrer" className="w-14 h-14 bg-white rounded-2xl shadow-sm flex items-center justify-center text-slate-500 hover:text-pink-500 transition-all active:scale-90 border border-gray-50">
              <Instagram size={28} />
            </a>
            <a href="https://wa.me/79286934009" target="_blank" rel="noreferrer" className="w-14 h-14 bg-white rounded-2xl shadow-sm flex items-center justify-center text-slate-500 hover:text-green-500 transition-all active:scale-90 border border-gray-50">
